...
for subi = 1:length(sub_name) % loop across subjects
    ...
    save([searchlight_result_dir 'searchlight_cosmo_', conds '_' sub_name{subi}...
        '_lda_ch' num2str(spacesphere) '_tbin' num2str(timesphere) '_frbin' num2str(freqsphere), '_.mat'], 'sl_tf_ds');
    ...
    save([searchlight_result_dir 'searchlight_ft_', conds '_' sub_name{subi}...
        '_lda_ch' num2str(spacesphere) '_tbin' num2str(timesphere) '_frbin' num2str(freqsphere), '_.mat'], 'all_ft');
    ...
    %% Clean
    clearvars -EXCEPT subi searchlight_result_dir sub_name conds fq_range spacesphere timesphere freqsphere nchunks Allsub_samples 
...
save([searchlight_result_dir 'searchlight_ft_allsub_' conds '_lda_ch' num2str(spacesphere)...
    '_tbin' num2str(timesphere) '_frbin' num2str(freqsphere) '.mat'], 'searchlight_cosmo_allsub');
...
save([searchlight_result_dir 'searchlight_ft_allsub_' conds '_lda_ch' num2str(spacesphere)...
    '_tbin' num2str(timesphere) '_frbin' num2str(freqsphere) '.mat'], 'searchlight_ft_allsub');
