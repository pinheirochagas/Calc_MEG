...
% bstImportRecordings(subjects, cond_lab, op_lab) % Already done
...
op_lab = {'op1_3', 'op1_4', 'op1_5', 'op1_6', 'op2_0', 'op2_1', 'op2_2', 'op2_3'};
...
source_z_sm_group(subjects,conditions,'MN')
