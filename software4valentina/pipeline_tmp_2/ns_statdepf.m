function stat=ns_statdepf(data1,data2,data3,data4,channel,latency)
...
cfg.statistic = 'depsamplesF'; % use the dependent samples T-statistic as a measure to evaluate 
...
cfg.contrastcoefs=[-1 -1 1 1;-3 -1 1 3; -3 -3 1 5];
