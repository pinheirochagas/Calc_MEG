% ns_lat2point() (identical to eeg_lat2point from eeglab) 
%                 - convert latencies in time units relative to the
...
function newlat = ns_lat2point( lat_array, epoch_array, srate, timewin, timeunit);
