function [roi,tpeakreal,xclus]=fp_plotsinglecluster_depregr_new(stat,sensor,cluster,tshw,varargin)
...
a=t(abs(tp)>0);
xclus=[a(1) a(end)];
fp_roierf_depregr(roi,[a(1) a(end)],sensors{sensor},varargin{:});
