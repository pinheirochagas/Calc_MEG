function dataclick=bst2ft_ds_singleitems_withrun_click(subj,cond)
...
dataclick.label=label;
dataclick.dimord=dimord;
dataclick.grad=grad;
...
% get trials but averages and not downsampled (retrieved by the associated Comment)
i=1;
...
dataclick.time=Time;
dataclick.trial=permute(trial,[3 1 2]);
dataclick.avg=mean(trial,3);
dataclick.runid=runid
