function varargout = process_ft_sourcestatistics_depsamplesregrT( varargin )
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'FieldTrip: ft_sourcestatistics_depsamplesregrT';
    sProcess.FileTag     = '';
    ...
    sProcess = process_ft_timelockstatistics_depsamplesregrT('DefineStatOptions', sProcess);
end


%% ===== FORMAT COMMENT =====
function Comment = FormatComment(sProcess) %#ok<DEFNU>
    Comment = process_ft_timelockstatistics_depsamplesregrT('FormatComment', sProcess);
end
...
%     end
    ...
    % ===== GET OPTIONS =====
    OPT = process_ft_timelockstatistics_depsamplesregrT('GetStatOptions', sProcess);
    % Number of files
...
%     end
    ...
    sAllInputs = sInputsA;
    nlevels=sProcess.options.regressionlevels.Value{1};
%     nsubj=length(sAllInputs)/sProcess.options.regressionlevels.Value;
