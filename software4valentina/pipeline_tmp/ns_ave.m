...
% - selects epochs identified by the event value trlval (NOTE: it is possible to select epochs labeled by more than
% one trigger value by defining more than one trlval...EXAMPLE TO SHOW)
...
% data.trialinfo by the function ns_trig)
