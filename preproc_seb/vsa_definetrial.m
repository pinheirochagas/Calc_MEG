function [data_epoch, ECGEOG, alltrigNew] = vsa_definetrial(par, dataset, databh, data_cont)
cfg = [];
...
[trigger_bh, onsets_bh] = retrieveEventsVSA(cfg);

% Retrieve trials from MEG correcting for behavior
[trl, alltrig, alltrigNew, hdr] = vsa_trialfun_neurospin(cfg, trigger_bh);
