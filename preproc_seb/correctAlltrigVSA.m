function [alltrig, exctrials, alltrigNew] = correctAlltrigVSA(alltrig, trigger_bh)
...
% This is a correction for when the subject didn't answer in the last trial
if max(correctTrialidx)+2 > length(alltrig)
    alltrig(end+1,:) = [0 0];
end
