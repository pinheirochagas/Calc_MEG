function [par dataout] = vsa_rejecttrials(par, datain, method)
...
datain.triggers = datain.triggers(y==0);
datain.trialinfo.run = datain.trialinfo.run(y==0);
datain.trialinfo.cue = datain.trialinfo.cue(y==0);
datain.trialinfo.targetAll = datain.trialinfo.targetAll(y==0);
datain.trialinfo.target = datain.trialinfo.target(y==0);
datain.trialinfo.targetSide = datain.trialinfo.targetSide(y==0);
datain.trialinfo.congruency = datain.trialinfo.congruency(y==0);
...
dataout.triggers = datain.triggers;
