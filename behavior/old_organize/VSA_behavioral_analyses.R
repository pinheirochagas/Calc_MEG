...
#path = sprintf("/Users/pinheirochagas/Pedro/NeuroSpin/Experiments/Calc_MEG/data/results/VSA/%s", subjname)

# Define paths
resultpath = sprintf("/Users/pinheirochagas/Pedro/NeuroSpin/Experiments/Calc_MEG/data/results/VSA/%s", subjname)
stimpath = sprintf("/Users/pinheirochagas/Pedro/NeuroSpin/Experiments/Calc_MEG/data/stimuli/VSA/%s/", subjname)
setwd(resultpath)
