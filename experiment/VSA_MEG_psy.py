...
output = -1
stop = False
while output <= 0 and not stop:
    output = pylink.getEYELINK().receiveDataFile(edfFileName, edfFileName)
    print output
    print 'write stop if you want to stop'
    answer = sys.stdin.readline()
    stop = answer.strip().lower() == 'stop'
