...
path = sprintf("/Users/pinheirochagas/Pedro/NeuroSpin/Experiments/Calc_MEG/data/results/VSA/pilot/%s", subjname)
...
#path = sprintf("/Users/pinheirochagas/Pedro/NeuroSpin/Experiments/Calc_MEG/data/stimuli/VSA/%s", subjname)
#setwd(path)
