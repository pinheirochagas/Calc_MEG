...
%         abs(AddSub{i}(:,5)-AddSub{i}(:,4)) 
    ...
    AddSubFinald5 = AddSubF(abs(AddSubF(:,5) - AddSubF(:,4))==5,:);
    AddSubFinald6 = AddSubF(abs(AddSubF(:,5) - AddSubF(:,4))==6,:);
    AddSubFinald7 = AddSubF(abs(AddSubF(:,5) - AddSubF(:,4))==7,:);
    AddSubFinald8 = AddSubF(abs(AddSubF(:,5) - AddSubF(:,4))==8,:);
    AddSubFinald9 = AddSubF(abs(AddSubF(:,5) - AddSubF(:,4))==9,:);
    ...
    AddSubstdFraw{rep} = [length(AddSubFinald1),length(AddSubFinald2),...
        length(AddSubFinald3),length(AddSubFinald4),length(AddSubFinald5),...
        length(AddSubFinald6),length(AddSubFinald7),length(AddSubFinald8),...
        length(AddSubFinald9),length(AddSubFinalSame)];    
...
AddSubFinald5 = AddSubFinalSmallSD(abs(AddSubFinalSmallSD(:,5) - AddSubFinalSmallSD(:,6))==5,:)
