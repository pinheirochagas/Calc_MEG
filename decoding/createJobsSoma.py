...
conditions = [['resultlock_absdeviant', 'resultlock_absdeviant'], ['resultlock_deviant', 'resultlock_deviant'],
              ['resplock_absdeviant', 'resplock_absdeviant'], ['resplock_deviant', 'resplock_deviant']]
