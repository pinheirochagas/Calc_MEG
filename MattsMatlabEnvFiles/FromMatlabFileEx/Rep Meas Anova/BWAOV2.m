...
%
%   MJN: the grouping variables must be consecutive integers, 1:n
%
%   MJN: This only works if all the subject numbers in ecah cell are
%   equal...
%
%   MJN: note- need to write code to include F stat and p-val correction from
%   epsilon stat (to correct for imperfect sphericity- see Stats Notes)
%
