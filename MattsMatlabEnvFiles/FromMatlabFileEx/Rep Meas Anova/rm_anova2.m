...
%
% MJN- this will work when there are different sample sizes per cell, but 
% only for the case with two within subject factors... also this won't
% report the subject effect...
%
% Parameters:
...
%    FACTNAMES is a cell array of factor names (only needed for the output)
%
...
if nargin <5 || isempty(FACTNAMES);     FACTNAMES={'F1','F2'};      end
stats = cell(4,5);
...
%Notes- F1 x Subj is the error term for Fact1 main effect,
%       F2 x Subj is the error term for Fact2 main effect,
%       F1 x F2 x Subj is the error term for the Fact 1 x Fact2 interaction
% Notes- Also, technically, I think the ANOVA table is supposed to be presented
%slightly differently... see: http://www.ling.ed.ac.uk/~astrid/stat99l9.html
%but I think what this outputs is fine too...     
 return