...
%
%%%% Notes from Matt on the logic of this procedure: This works as if we
%%%% can reject on hypothesis, you can sort of "put that in the books" and
%%%% consider the hypotheses independently, as if the significant
%%%% hypothesis never existed. Otherwise, one would be being slightly too
%%%% conservative...
%
