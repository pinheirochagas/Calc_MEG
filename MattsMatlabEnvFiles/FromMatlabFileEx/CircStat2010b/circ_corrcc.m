...
%
% MJN notes: YES, this rho shoul go from -1 to 1, like a normal correlation
% coefficient. this corresponds to rhoT on pg 151 of the N.I. Fihser
% circular statistics book.
%
%   Input:
