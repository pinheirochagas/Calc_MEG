...
switch nargin
    case 1;     [p,h,stat]=nanranksum(x);
    case 2;     [p,h,stat]=nanranksum(x,varargin{1});
    case 3;     [p,h,stat]=nanranksum(x,varargin{1},varargin{2});
    case 4;     [p,h,stat]=nanranksum(x,varargin{1},varargin{2},varargin{3});
end
