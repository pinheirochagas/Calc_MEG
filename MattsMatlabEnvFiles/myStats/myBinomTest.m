...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 110413: My personal note on Greater vs Two: For testing a significant 
% proportion of significant hypothesis tests, I blieev you are justified in
% using greater. HOWEVER- for smallish samples, often this gives the same
% value as 'Two', WHICH IS CORRECT- as this is based on the deviation of
% the actual from the expected value. Say if you run 100 hypooth. tests
% at the .05 level, and find 12 of them to be significant, the expected
% number fo sigs is 5, 12 exceed that by 7, so all the contribution to
% being "7 away from teh expected value" comes from the Greater proportion.
% (The lesser proportion would indicate the cahnce of having -2 or less
% successes, which is of course 0)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Inputs:
