...
% plot the log of that as normal (using PostHocSpecPlot). Then, the
% relation of the resulting log ratio to 0 tells which was larger... if
% they are equal everywhere, the log ratio will be zero everywhere
%
