...
if nargin<4 || isempty(sampling)   sampling=1000/6; end
...
if plotflag
    ...
    if exist('CLim','var')
        imagesc((abs(coh')),CLim) %[-8 -7.99] add 1e-8 to avoid plotting log of zero, it happens with fake data sometimes
    else
        imagesc((abs(coh')))
    end
    axis xy
