function err=AcrossSessWInConds1DShuffTest_AllFreqBinSizes (TestStats1,TestStats2,f,ClusShuffOpts,pval)
%function err=AcrossSessWInConds1DTFShuffTest(TestStats,TestStats2,f,ClusShuffOpts,pval)
%
...
tmpInd=ceil(pval*nShuffs);
if isinteger(pval*nShuffs);     tmpInd=tmpInd+1;        end
