...
%           spike in each trial down the other, relative to some consistent
%           event in the trial. SPK is assumed to be Nan-padded so that 
%           it's width is equal to the maximum number of spikes in one 
%           trial.
...
if ktype==1     %psp kernel
    ...
    BW=1000;    %half the width of the gaussian kernel
