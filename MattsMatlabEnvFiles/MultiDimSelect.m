...
%
% See the usage in ParisImpPatch_CollapseAmpTypesPlot_FreqGroups... for normal use, you want to make sure your later dimension argument is a COLUMN vector, not a ROW vector!    
%
